...
class Music(commands.Cog, name="Music"):
    ...
    @commands.command(name="play", aliases=["p"], description="Play a song or add it to the queue")
    @commands.guild_only()
    ...
    @commands.command(name="volume", aliases=["vol"], description="Set volume (0–200)")
    @commands.guild_only()
    ...
    @commands.command(name="queue", aliases=["q"], description="Show the music queue")
    @commands.guild_only()
    ...
    @commands.command(name="nowplaying", aliases=["np"], description="Show the current track")
    @commands.guild_only()
    ...
    @commands.command(name="loopqueue", aliases=["lq"], description="Toggle queue loop")
    @commands.guild_only()
    ...
    @commands.command(name="leave", aliases=["dc", "disconnect"], description="Leave the voice channel")
    @commands.guild_only()
    ...
    @commands.command(name="clearqueue", aliases=["cq"], description="Clear the music queue")
    @commands.guild_only()
